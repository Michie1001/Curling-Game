...
void RenderScene(void) {
	...
	//Draw the house boundaries where the button will be
	...
	glBegin(GL_LINES);
	glVertex3f(-1.3, 0.0, 7.8);
	glVertex3f(1.3, 0.0, 7.8);

	glVertex3f(0.3, 0.0, 7.8);
	glVertex3f(0.3, 0.0, 7.2);
...
int _tmain(int argc, _TCHAR* argv[])
{
	...
	//glutFullScreen();
	glutCreateWindow("Assessment : Curling Game");
	#if DRAW_SOLID
	InitLights();
	#endif
